...
,
		"classnamespace" : "box",
		"rect" : [ 1137.0, 159.0, 1306.0, 1134.0 ],
		"bglocked" : 0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 142.0, 384.599976000000197, 44.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 92.73817902803421, 2.0, 44.0, 15.0 ],
...
,
					"patching_rect" : [ 146.0, 653.0, 47.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 207.0, 603.0, 150.0, 18.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"activebgoncolor" : [ 0.956, 0.0, 0.0, 1.0 ],
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 173.5, 618.000000000000227, 10.0, 10.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 357.919995844364166, 4.5, 10.0, 10.0 ],
					"rounded" : 15.0,
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 142.0, 447.599976000000197, 40.0, 22.0 ],
					"text" : "* 100."
				}
...
,
					"patching_rect" : [ 142.0, 498.999970000000076, 69.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 191.0, 447.599976000000197, 36.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 315.35655602803422, 2.0, 36.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_initial" : [ 0 ],
							"parameter_initial_enable" : 1,
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 146.0, 547.999970000000076, 202.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 134.73817902803421, 1.0, 180.751342812705957, 16.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 352.5, 517.499970000000076, 141.0, 78.0 ],
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 155.5, 713.099976000000197, 103.0, 713.099976000000197, 103.0, 346.099976000000197, 200.5, 346.099976000000197 ],
					"source" : [ "obj-79", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 216.5, 643.599976000000197, 183.5, 643.599976000000197 ],
					"order" : 0,
					"source" : [ "obj-80", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 216.5, 642.599976000000197, 198.0, 642.599976000000197, 198.0, 600.599976000000197, 177.5, 600.599976000000197 ],
					"order" : 1,
					"source" : [ "obj-80", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-85::obj-15" : [ "Unmap[8]", "unmap", 0 ],
			"obj-85::obj-19" : [ "Map[8]", "Map", 0 ],
			"obj-85::obj-20" : [ "Max[8]", "Max", 0 ],
			"obj-85::obj-26" : [ "Min[8]", "Min", 0 ],
			"parameterbanks" : 			{
